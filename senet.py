...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers,in_ch=3, num_classes=1000):
        self.inplanes = 64
...
def getResNet(layers, in_ch, pretrained=False, **kwargs):
    model = SENet(BasicBlock, layers,in_ch=in_ch, **kwargs)
    return model
